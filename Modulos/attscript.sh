...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://raw.githubusercontent.com/Penguinehis/CrashVPN/main/versao
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://raw.githubusercontent.com/Penguinehis/CrashVPN/main/crashvpn > /dev/null 2>&1
